...
class UserOnlineStatusService:
    ...
    def add_user_connection(self, user_id, connection_id):
        ...
        logger.info(
            f"User {user_id} connected (connection {connection_id}). Total connections: {connection_count}"
        )
    ...
    def remove_user_connection(self, user_id, connection_id):
        ...
        logger.info(
            f"User {user_id} disconnected (connection {connection_id}). Remaining connections: {connection_count}"
        )
        return connection_count
