...
class Consultation(models.Model):
    ...
    class Meta:
        ...
        permissions = [
            ...
            ("assignee_change_consultation", _("Can change own assigned consultations")),
            ("assignee_delete_consultation", _("Can delete own assigned consultations")),
            ("assignee_close_consultation", _(
                "Can close own assigned consultations")),
        ]
