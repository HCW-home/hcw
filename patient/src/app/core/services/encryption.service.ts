...
export class EncryptionService {
  ...
  // Same format as the practitioner side: { salt, iv, ciphertext } base64.
  // The passphrase NEVER leaves the browser. The server only stores and
  // serves the encrypted blob.
