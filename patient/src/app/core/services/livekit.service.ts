...
export class LiveKitService implements OnDestroy {
  ...
  private setupRoomEventListeners(): void {
    ...
    this.room.on(RoomEvent.TrackUnsubscribed, (_track: RemoteTrack, _publication: RemoteTrackPublication, _participant: RemoteParticipant) => {
      this.updateParticipants();
    });
    ...
    this.room.on(RoomEvent.TrackUnpublished, (_publication: RemoteTrackPublication, _participant: RemoteParticipant) => {
      this.updateParticipants();
    });
